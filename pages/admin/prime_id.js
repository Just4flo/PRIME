...
const COLLECTION_NAME = "prime_id";
...
export default function MembersPage() {
    ...
    const handleAddMember = async () => {
        ...
        try {
            const docRef = await addDoc(collection(db, COLLECTION_NAME), newMember);
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex-1 lg:ml-64 p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-gray-100 via-purple-200 to-indigo-300 text-black">
                ...
                <h1 className="text-3xl font-bold mb-6">Manage PRIME ID</h1>
