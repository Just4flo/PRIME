...
export default function EventList() {
    // 1. Ubah data untuk menampilkan grup PRIME dan PRIME ID
    const eventGroups = [
        {
            id: 1,
            title: "PRIME",
            image: "/download (2).jpeg", // Ganti dengan gambar yang sesuai
            slug: "prime",
        },
        {
            id: 2,
            title: "PRIME ID",
            image: "/pc wallpaper.jpeg", // Ganti dengan gambar yang sesuai
            slug: "prime_id",
        },
    ];
            ...
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    {eventGroups.map((group) => (
                        // 2. Arahkan Link ke halaman perantara, misal /events/prime
                        <Link key={group.id} href={`/events/${group.slug}`} passHref>
                            <motion.div
